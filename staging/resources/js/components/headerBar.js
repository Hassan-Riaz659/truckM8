        ...
        <ul className="navbar-nav ml-auto">
          ...
          <li className="nav-item dropdown no-arrow">
            <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img className="img-profile rounded-circle" src="https://integrityinsurance.dev505.io/public/theme/img/boy.png" style={{maxWidth: '60px'}} />
            ...
            <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
              ...
              <a className="dropdown-item" href="https://integrityinsurance.dev505.io/public/logout">
