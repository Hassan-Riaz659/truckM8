                ...
                <div class="row">
                    ...
                    <div class="col-3">
                   	...
                   	<div class="col-lg-6 col-md-10 col-sm-12">
						<form method="POST" action="{{route('store.EditDriver', $driver->id)}}" >
							@csrf
							  <div class="form-row">
							    
							    <div class="form-group col-md-12">
							      <label for="name">Name</label>
							      <input type="text" class="form-control" required="Please enter name" value="{{$driver->name}}" name="name" id="name" placeholder="Enter driver  name">
							    </div>
							    ...
							    <div class="form-group col-md-12">
							      ...
							      <input type="text" class="form-control" value="{{$driver->surname}}" required="Please enter surname" name="surname" id="surname" placeholder="Enter Surname">
							    </div>
							    ...
							    <div class="form-group col-md-12">
							      ...
							      <input type="text" class="form-control" value="{{$driver->id_number}}" required="Please enter id_number" name="id_number" id="id_number" placeholder="Enter ID Number">
							    </div>
							    ...
							    <div class="form-group col-md-12">
							      ...
							      <input type="text" class="form-control" required="Please enter name" value="{{$driver->license_number}}" name="license_number" id="license_number" placeholder="Enter License Number">
							    </div>
							    ...
							    <label for="license_expiry">License Expiry Date</label>
							 		<div class="input-group" >
						  			<input type="text" name="license_expiry" value="{{$driver->license_expiry_date}}" required="" id="pickadate" class="form-control" placeholder="License Expiry Date">
								  		</div>
							    </div>
							 </div>
