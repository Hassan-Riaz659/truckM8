                ...
                <div class="row">
                    ...
                    <div class="col-3">
                   	...
                   	<div class="col-lg-6 col-md-10 col-sm-12">
						<form method="POST" action="{{route('storeLoad')}}" >
							@csrf
							  <div class="form-row">
							    
							    <div class="form-group col-md-12">
							      <label for="customer">Customer</label>
							      <input type="text" class="form-control" required="Please enter customer" name="customer" id="customer" placeholder="customer">
							    </div>
							  </div> 
							    <div class="form-row">
							    <div class="form-group col-md-12" >
							    <label for="pickup">Pickup Date</label>
							 		<div class="input-group" >
						  			<input type="text" name="pickup" required="" id="pickadate" class="form-control" placeholder="Choose Pickup Date">
								  		</div>
							    </div>
							 </div>
							  ...
							  <div class="form-row">
							    ...
							    <label for="destination">Destination Date</label>
							 		<div class="input-group" >
						  			<input type="text" name="destination" required="" id="pickadate2" class="form-control" placeholder="Choose Destination Date">
								  		</div>
							    </div>
							 </div>
							 ...
							 <div class="form-row">
							    ...
							    <label for="pickup_location">Pickup Location</label>
							 		<div class="input-group" >
						  		<input type="text" class="form-control" required="" id="pickup_location" name="pickup_location" placeholder="Pickup Location">
						  		  		</div>
							    </div>
							 </div>
							  ...
							  <div class="form-row">
							    <div class="form-group col-md-6">
							      ...
							      <input type="text" class="form-control" required="" name="drop_off_location" id="drop_off_location" placeholder="Drop Off Location">
							    </div>
							    <div class="form-group col-md-6">
							      <label for="distance">Distance (KM)</label>
							        <input type="number" class="form-control" required="" name="distance" id="distance" placeholder="Distance in km">
							    </div>
							 ...
							 <label for="customer_reference">Customer Reference</label>
							      <input type="text" class="form-control" required="" name="customer_reference" id="customer_reference" placeholder="Customer Reference">
							    </div>
							   
							    <div class="form-group col-md-6" >
							    
							 	 <label for="load_number">Load Number</label>
							      <input type="number" class="form-control" required="" name="load_number" id="load_number" placeholder="Load Number">
							 ...
							 <label for="additional_details">Additional Details</label>
							      <input type="text" class="form-control" required="" name="additional_details" id="additional_details" placeholder="Additional Details">
							    </div>
							   
							    <div class="form-group col-md-6" >
							    
							 	 <label for="vehicle">Vehicle</label>
							      <input type="text" class="form-control" required="" name="vehicle" id="vehicle" placeholder="Vehicle">
							 ...
							 <label for="driver">Driver</label>
							      <input type="text" class="form-control" required="" name="driver" id="driver" placeholder="Driver">
							    </div>
							   
							    <div class="form-group col-md-6" >
							    
							    <label for="rate">Rate</label>
							      <input type="number" class="form-control" name="rate" required="" id="rate" placeholder="Rate">
							    </div>
							 ...
							 <div class="form-row">
							   ...
							   <textarea class="form-control" required="" cols="5" rows="5" name="notes" id="notes" placeholder="Notes" ></textarea>
